  ...
  [888],
  {
    ...
    9895: function (e, t, n) {
      ...
      (t.defaultConfig = s),
        (t.initConfig = function (e, n) {
          ...
          d && h && l.token && !0 !== l.ignoreBrowserTokenWarning
          ...
          var y = l.apiHost.split("://", 2),
            v = y[0],
            m = y[1],
            g = l.isDefaultApi ? "apicdn.sanity.io" : m;
          return (
    ...
    6102: function (e) {
      ...
      e.exports = function (e) {
        var o = e.query,
          ...
          l = n(c, t),
          f = "query=".concat(r(o)),
          p = u ? "?tag=".concat(r(u), "&").concat(f) : "?".concat(f),
    ...
    5420: function (e, t, n) {
      ...
      e.exports = function (e, t) {
        var n =
          ...
          g = n.tag && m ? [m, n.tag].join(".") : n.tag,
          b = o(o({}, l(n, h)), {}, { tag: g }),
          w = u(b, d),
          O = f({ query: e, params: t, options: w, tag: g }),
          x = "".concat(i).concat(this.getDataUrl("listen", O));
        if (x.length > 14800)
          return new s(function (e) {
            return e.error(new Error("Query too large for listener"));
          });
        var j = b.events ? b.events : ["mutation"],
          E = -1 !== j.indexOf("reconnect"),
          _ = {};
        return (
          (a || c) && (_.withCredentials = !0),
    ...
    7343: function (e, t, n) {
      ...
      var r = n(6258),
        ...
        y = r(n(1708).concat([h, a(), s(), c(), d, i({ implementation: u })]));
    ...
    9729: function (e, t, n) {
      ...
      function E() {
        ...
        if (
          (this.config(e),
          (this.assets = new y(this)),
          (this.datasets = new d(this)),
      ...
      i(E.prototype, p),
        i(E.prototype, {
          ...
          config: function (e) {
            ...
            return (this.clientConfig = x(e, this.clientConfig || {})), this;
          },
          ...
          _requestObservable: function (e) {
            ...
            u &&
              (e.query = (function (e) {
                ...
                return e;
              })({ tag: j.requestTag(u) }, e.query));
            var l = b(this.clientConfig, i({}, e, { url: this.getUrl(n, c) }));
            return new s(function (e) {
              return g(l, t.clientConfig.requester).subscribe(e);
            });
          },
          request: function (e) {
        ...
        (E.Patch = l),
        (E.Transaction = f),
        (E.ClientError = g.ClientError),
        (E.ServerError = g.ServerError),
        (E.requester = g.defaultRequester),
        (e.exports = E);
    },
    1102: function (e, t, n) {
      "use strict";
    ...
    6803: function (e) {
      e.exports = (function () {
        ...
        function t(t) {
          ...
          return { id: r, width: s, height: c, format: i };
        }
        ...
        function l(e) {
          ...
          var a = t(o.asset._ref || o.asset._id || ""),
            ...
            v = { left: h - d, top: y - l, right: h + d, bottom: y + l };
          return (
            n.rect ||
              n.focalPoint ||
              n.ignoreImageParams ||
        ...
        function p(e, t) {
          ...
          if (i.width / i.height > s) {
            var c = Math.round(i.height),
              ...
              p = Math.max(0, Math.round(f - u / 2));
            p < i.left
              ? (p = i.left)
              : p + u > i.left + i.width && (p = i.left + i.width - u),
              (n = {
                left: p,
                top: l,
                width: u,
            ...
            var d = i.width,
              ...
              m = Math.max(0, Math.round(v - h / 2));
            m < i.top
              ? (m = i.top)
              : m + h > i.top + i.height && (m = i.top + i.height - h),
              (n = {
                left: y,
                top: m,
                width: d,
        ...
        return (
          (b.prototype.withOptions = function (e) {
            var t = e.baseUrl || this.options.baseUrl,
              n = { baseUrl: t };
            for (var r in e) e.hasOwnProperty(r) && (n[m(r)] = e[r]);
    ...
    8541: function (e, t) {
      ...
      !(function (i) {
        ...
        (void 0 != v &&
          ...
          (function () {
            try {
              return (
                "test" ===
                new v().decode(new m().encode("test"), { stream: !0 })
              );
            } catch (e) {
              console.debug(
        ...
        (x.prototype.open = function (e, t) {
          ...
          (A.prototype.open = function (e, t, n, r, o, i, a) {
            var s = null,
              c = new g(),
              u = c.signal,
              l = new v();
                ...
                V = function (t, n, r, o) {
                  if (0 === O)
                    if (200 === t && void 0 != r && N.test(r)) {
                      ...
                      e.dispatchEvent(a), L(e, e.onopen, a);
                    } else {
                      var s = "";
                      200 !== t
                        ? (n && (n = n.replace(/\s+/g, " ")),
                      ...
                      e.dispatchEvent(a), L(e, e.onerror, a), console.error(s);
                    }
                },
                z = function (t) {
                  if (1 === O) {
                    ...
                    for (var c = 0; c < o.length; c += 1) {
                      ...
                      if (S === R && u === "\n".charCodeAt(0)) S = 0;
                        ...
                        S = u === "\r".charCodeAt(0) ? R : 0;
                      } else
                        0 === S && ((C = c), (S = 1)),
                          1 === S
                            ? u === ":".charCodeAt(0) && ((H = c + 1), (S = 2))
                            : 2 === S && (S = 3);
                    }
                  }
                },
        ...
        var U = void 0 != h && void 0 != y && "body" in y.prototype;
    ...
    7288: function (e, t, n) {
      ...
      a || ((c = i), (f = i)),
        (e.exports = function (e, t) {
          ...
          var h = l ? new f() : new c(),
            y = a && a.XDomainRequest && h instanceof a.XDomainRequest,
            v = i.headers,
            m = i.timeout,
            g = !1,
            b = !1,
          ...
          if (
            ...
            (h[y ? "onload" : "onreadystatechange"] = function () {
              !(function () {
                if (!m) return;
                j(),
                        ...
                        t(
                          ...
                          (function () {
                            ...
                            return {
                              ...
                              url: i.url,
                              method: i.method,
                              headers: y ? {} : o(h.getAllResponseHeaders()),
                              statusCode: e,
                              statusMessage: t,
                            };
                          })()
            ...
            for (var O in v) v.hasOwnProperty(O) && h.setRequestHeader(O, v[O]);
          else if (v && y)
            throw new Error(
    ...
    6505: function (e, t, n) {
      ...
      var r,
        ...
        i = (r = n(148)) && r.__esModule ? r : { default: r },
        a = n(7285),
        s = n(523),
        c = n(9546);
      n(7206);
    ...
    6525: function (e, t, n) {
      ...
      var u = {
        ...
        f = function (e) {
          ...
          e.title
            ? ((a = e.title),
              u.templateTitle &&
                (a = u.templateTitle.replace(/%s/g, function () {
                  return a;
                })))
            : e.defaultTitle && (a = e.defaultTitle),
            a && i.push(o.createElement("title", { key: "title" }, a));
          var c,
            f,
            p = e.noindex || u.noindex || e.dangerouslySetAllPagesToNoIndex,
            d = e.nofollow || u.nofollow || e.dangerouslySetAllPagesToNoFollow,
            h = "";
          if (e.robotsProps) {
            var y = e.robotsProps,
              v = y.nosnippet,
          ...
          (null != (t = e.openGraph) && t.title) || a) &&
            i.push(
              o.createElement("meta", {
                key: "og:title",
                property: "og:title",
                content: (null == (c = e.openGraph) ? void 0 : c.title) || a,
              })
            );
      ...
      new RegExp("[" + Object.keys(d).join("") + "]", "g");
      var h = n(4304),
        y = n(3023),
        v = n(5152),
        m = n.n(v),
        ...
        return (0, x.jsxs)(
          ...
          E(
            ...
            {},
            {
              ...
              children: [
                (0, x.jsx)("path", {
                  d: "M184 173h-62.889c-22.308 0-44.82-3.856-66.5-9-13.698-3.25-27.036-7.592-40.666-11-1.89-.472-6.718-1.99-7.722-4-1.068-2.136-.223-6.478-.223-8.722 0-8.443.894-16.694 2-25.056 2.973-22.462 3.815-44.008 10-66 2.012-7.153 3.271-14.701 3.945-22.11.491-5.41-1.201-11.878.61-17.056C24.31 5.046 25.494 5 30.556 5 38.914 5 46.87 7.767 55 9.556c11.506 2.53 22.825 7.933 34.556 9.222 12.203 1.34 23.299 3.125 35.222 6.444C142.36 30.116 160.247 32.94 178 36.778c7.877 1.703 17.998-.663 25.445 2.722C209.78 42.38 217 41.88 217 50c0 8.311-.122 16.493-1 24.778-1.479 13.963-.517 28.406-2.777 42.222-.765 4.674-1.498 10.62-3.445 15-.65 1.463-2.695 4.599-2.778 6-.274 4.67-3 9.442-3 14.5 0 3.827-.945 9.557-1.944 13.056-1.315 4.603-2.122 7.437-7.278 9.222-5.589 1.934-11.526 1.848-16.778-.778",
                  strokeWidth: 10,
                  strokeLinecap: "round",
                }),
                (0, x.jsx)("path", {
                  d: "M27 10c-.578.082 10.877 15.592 12.222 17.222C46.939 36.58 53.75 45.755 60.055 56 64.325 62.938 67.21 71.297 72 77.778c3.709 5.018 7.62 11.24 10.5 16.778 4.186 8.049 14.633 16.606 23.722 18.222 5.389.958 10.839 1.188 16.222 2.166 4.031.733 8.699.056 12.778.056 11.762 0 23.672-9.894 31.778-18 3.551-3.551 7.427-6.529 11-10 1.801-1.75 4.038-2.972 5.777-4.778 1.627-1.689 1.731-4.304 3.223-6.222 5.71-7.342 12.528-13.68 18.222-21 2.398-3.083 5.514-5.736 8.278-8.5 1.916-1.917 3.176-5.338 5.5-6.5M6 147c9.994 0 19.57-7.906 27.778-13 6.054-3.758 12.173-6.748 18.222-10.444C62.858 116.92 76.24 114.38 87 109M197 172c-2.354-7.649-11.411-14.336-16.5-20.556-4.973-6.078-9.892-12.183-14.722-18.444-5.089-6.596-10.03-12.417-17.778-15",
                  strokeWidth: 10,
                  strokeLinecap: "round",
                }),
              ],
      ...
      function SS(e) {
        return (0, x.jsx)(
          "svg",
          D(
            D({ width: 15, height: 15, viewBox: "0 0 15 15", fill: "none" }, e),
            {},
            {
      ...
      function R(e) {
        return (0, x.jsx)(
          ...
          D(
            D(
              { width: 257, height: 210, viewBox: "0 0 257 210", fill: "none" },
              e
            ),
            {},
            {
              children: (0, x.jsx)("path", {
                d: "M33.816 81.11c-1.906-.238-4.097-5.485-5.222-7-3.557-4.787-7.213-9.952-9.722-15.388-1.983-4.297-2.056-12.123-2.056-16.834 0-3.647-1.42-10.492.222-13.777.79-1.58 3.497-.9 4.778-2.5.49-.614 12.215 11.985 12.945 13.444 1.882 3.765 7.894 6.394 11.055 9.056 4.289 3.611 11.327 4.987 16.222 8 3.485 2.144 9.344 4.219 13.334 4.944 3.705.674 7.756 1.861 11.444 2.056 2.225.117 4.225 2 6.5 2 4.378 0 8.797 2 13.5 2 3.143 0 9.013.45 12 1.777 4.69 2.085 2-8.174 2-10.833 0-6.727-.527-13.747.056-20.444.401-4.613 2.507-13.112 6.944-15.723 1.175-.691 4.146-3.21 5-4.277.998-1.248 4.46-1.046 6-2.5 6.142-5.801 19.065-10 27.5-10 7.818 0 17.562-.862 24.5 2.222 6.112 2.716 18.123 7.459 20.056 14.222.498 1.745 17.788-8.264 19.944-9.222 2.519-1.12 8.745-3.111 11.444-3.111 4.414 0-5.299 12.207-5.444 12.389-5.599 6.998-12.695 11.403-19.222 17.277-5.968 5.372.309 2.223 4.722 2.223 5.347 0 10.041-4 15-4 4.383 0 8.069-3 12.5-3 3.679 0 1.847-.466-.5.055-2.281.507-4.896 2.34-6.5 3.945-1.367 1.367-2.866 2.421-4.222 3.777-1.565 1.565-1.81 4.143-3.334 5.667-3.612 3.612-7.683 4.152-11.888 6.556-6.101 3.486-3.556 15.7-3.556 22.5 0 11.944-3.442 27.736-10.222 37.5-2.492 3.588-5.522 13.885-9.222 16-5.281 3.017-9.29 11.977-12.945 16.444-5.214 6.373-14.491 11.74-18.833 19.556-1.58 2.844-5.056 3.269-7.556 5-2.598 1.798-5.092 3.679-7.722 5.5-3.424 2.37-7.601 4.589-9.5 8.5-.961 1.978-.838 3.668-1 5.777-.151 1.962-5 1.434-6.444 1.723-6.501 1.3-13.548 2.876-19.556 5.722-5.807 2.75-12.492 5.778-19 5.778-22.041 0-45.703 2.392-66-7.223-5.306-2.513-10.618-4.892-15.944-7.222-5.995-2.622-17.751-4.555-2-4.555 13.765 0 28.49 1.454 38.944-9 3.562-3.563 9.055-7.022 13.944-8 1.052-.211 7.192-2.501 7.834-3.223 1.153-1.296-10.952-5.818-12.278-6.222-7.37-2.243-12.886-6.2-19.5-9.333-2.206-1.045-4.126-.898-6.444-2.222-1.463-.836-3.032-3.051-4.334-4.223-1.275-1.147-3.29-3.268-4-4.777-.177-.378 3.565-2.676 4.334-3.445 2.14-2.14 8.072-3.555 10.944-3.555 2.47 0 10.264-2.863 9.056-3.223-12.906-3.836-22.045-14.265-30.556-23.777-4.381-4.897-9.093-10.136-9.944-16.945-.264-2.109-1.131-4.477-2.056-6.5-1.392-3.045-3.6-7.411.5-6.5 8.33 1.851 16.573 7.326 23.5 11.945",
                strokeWidth: 10,
                strokeLinecap: "round",
              }),
            }
      ...
      var N = o.memo(R),
        ...
        G = function (e) {
          ...
          return (0, x.jsx)(y.TW, {
            ...
            children: (0, x.jsxs)("a", {
              ...
              onClick: function () {
                (0, h.B)("cta", {
                  type: "social-".concat(r.toLowerCase()),
                  location: "bottom-nav",
                });
              },
              children: [
                (0, x.jsx)(t, { className: "w-[2em] h-[1.625em]" }),
                (0, x.jsx)("span", {
                  className: "sr-only",
                  children: r,
                }),
        ...
        L = function () {
          var e,
            ...
            n = (function () {
              var e = (0, O.L)().scene;
              return "project-open" !== e && "intro" !== e && "start" !== e;
            })(),
            r = (0, o.useState)(0),
            i = r[0],
            a = r[1];
            ...
            children: [
              ...
              (0, x.jsx)(y.TW, {
                ...
                children: (0, x.jsxs)("a", {
                  ...
                  onBlur: _,
                  onClick: function () {
                    (0, h.B)("cta", { type: "email", location: "nav" });
                  },
                  children: [
                    (0, x.jsx)("h2", {
                      className: "sr-only",
                    ...
                    (0, x.jsxs)("span", {
                      className:
                        "tracking-[-0.01em] flex gap-[0.75em] underline decoration-2 underline-offset-[6px]",
                      children: [
                        (0, x.jsx)(k, { className: "w-[2em] h-[1.625em]" }),
                        null !== (e = q[i]) && void 0 !== e
                          ? e
                          : (0, x.jsxs)("span", {
                              children: [
              ...
              j &&
                (0, x.jsx)("div", {
                  className:
                    "top-0 left-0 fixed w-full h-full overflow-hidden z-[-1] text-[2vw] font-mono text-white break-all opacity-30",
                  "aria-hidden": !0,
                  children: new Array(2e3).fill(null).map(function () {
                    return "zoomer!";
                  }),
                }),
            ],
        ...
        H = function (e) {
          ...
          return (
            ...
            r ? (0, x.jsx)("div", { className: "sr-only", children: t }) : null
          );
        },
        U = n(1158),
        V = n(9152),
        ...
        B = m()(
          function () {
            return Promise.all([n.e(737), n.e(864), n.e(423)]).then(
              n.bind(n, 423)
            );
          },
          {
            ...
            children: [
              (0, x.jsxs)(a(), {
                children: [
                  (0, x.jsx)("title", {
                    children:
                      "Vitalik Wojak: When You Need A Meme To Match The Mood!",
                  }),
                  (0, x.jsx)("meta", {
                    name: "description",
              ...
              (0, x.jsxs)("main", {
                className:
                  "w-screen h-[calc(100*var(--vh))] font-sans overflow-hidden",
                children: [
                  (0, x.jsx)(H, {
                    children: (0, x.jsxs)(x.Fragment, {
                      children: [
                        (0, x.jsx)("h1", { children: "VitalikWojak.site" }),
                        U.N.intro.map(function (e) {
                          return (0, x.jsx)("p", { children: e }, e);
                        }),
                        (0, x.jsx)("h2", { children: "About" }),
                        (0, x.jsx)("h3", { children: "Mission" }),
                        U.N.mission.map(function (e) {
                          return (0, x.jsx)("p", { children: e }, e);
                        }),
                        (0, x.jsx)("h3", { children: "Testimonials" }),
                        (0, x.jsx)("ul", {
                          children: U.N.testimonials.map(function (e) {
                            var t;
                            return (0,
                            x.jsx)("li", { children: (0, x.jsxs)("figure", { children: [(0, x.jsx)("blockquote", { children: e.quote }), (0, x.jsxs)("figcaption", { children: ["\u2013", null === e || void 0 === e ? void 0 : e.name, ",", null === e || void 0 === e || null === (t = e.title) || void 0 === t ? void 0 : t.join(", ")] })] }) }, e.quote);
                          }),
                        }),
                        (0, x.jsx)("h3", { children: "Skills" }),
                        (0, x.jsx)("ul", {
                          children: U.N.skills.map(function (e) {
                              ...
                              (t =
                                ...
                                void 0 === n
                                  ...
                                  : n.map(function (e) {
                                      var t;
                                      return (0,
                                      x.jsx)("li", { children: (0, x.jsxs)("article", { children: [(0, x.jsx)(V.T4, { project: e }), (0, x.jsx)(V.jE, { project: e })] }) }, null !== (t = null === e || void 0 === e ? void 0 : e.title) && void 0 !== t ? t : "");
                                    })) && void 0 !== t
                              ? t
                              : null,
                        }),
        ...
        $ = function () {
          var e = (0, o.useState)("1vh"),
            t = e[0],
            n = e[1],
            r = function () {
              n("".concat(0.01 * window.innerHeight, "px"));
            };
          return (
            o.useEffect(r, []),
            (0, g.OR)("resize", r),
        ...
        Z = function () {
          var e = (function () {
              ...
              return (
                (0, o.useEffect)(function () {
                  n(!!navigator.userAgent.match(/Version\/[\d\.]+.*Safari/));
                }, []),
                t
              );
            })(),
            t = "font-size: 20px;  ".concat(
              e ? "" : "display:inline-block; padding: 10px;"
            ),
            n =
              "color: white; background: blue; font-family:monospace; ".concat(
                t
              ),
            r = function (e) {
              return console.log("%c".concat(e.toUpperCase()), n);
            };
          (0, g.KS)(function () {
            r("looking at my code, are you?"),
              r("awesome! dig around!"),
              r("Although you'll probably have more luck looking at the repo:"),
              r("hmu to nerd out about any of it!"),
              r("hello@VitalikWojak.site");
          }, 1e3);
        },
        J = n(7730),
        Q = function () {
              ...
              (0, o.useEffect)(function () {
                ...
                return (
                  ...
                  e.play().catch(function (t) {
                    var n;
                    console.warn("Low power mode detected via error", t),
                      r(!0),
                      null === (n = e) || void 0 === n || n.remove(),
                      (e = null);
                  }),
                  function () {
                    e && (e.remove(), (e = null));
                ...
                function () {
                  var e = function () {
                    if (n && !s) {
                      c(!0);
                      var e = document.createElement("video");
                      (e.muted = !0), e.play(), e.remove(), (e = null);
                    }
                  };
                  return (
      ...
      var K = function (e) {
        var t,
          ...
          o = e.pageProps,
          i = {
            startingScene: null !== (t = o.scene) && void 0 !== t ? t : "error",
            projects: null !== (n = o.projects) && void 0 !== n ? n : null,
          };
        Z();
        var a = "WOJAK | Ethereum Chain",
          s =
            "A groundbreaking digital token, drawing inspiration from the iconic Wojak meme.";
        return (0, x.jsxs)(x.Fragment, {
          children: [
            (0, x.jsx)(p, {
              title: a,
              description: s,
              canonical: "https://vitalikwojak.site",
              openGraph: {
                url: "https://vitalikwojak.site",
                title: a,
                description: s,
                type: "website",
                images: [
                  {
                    url: "https://vitalikwojak.site/images/social.png",
                    width: 2333,
                    height: 1313,
                    alt: "An innovative and exciting digital asset inspired by the famous Wojak meme.",
                    type: "image/png",
                  },
                ],
                site_name: "https://vitalikwojak.site",
              },
              twitter: {
                handle: "@VitalikWojak",
            ...
            (0, x.jsx)(h.Wi, { trackPageViews: !0 }),
            (0, x.jsx)($, {}),
            (0, x.jsx)(W, { siteData: i }),
            (0, x.jsx)(r, X({}, o)),
            (0, x.jsx)(y.e7, {}),
            (0, x.jsx)(Q, {}),
          ],
    ...
    3023: function (e, t, n) {
      ...
      var r = n(7812),
        ...
        h = function () {
          return (0, l.jsxs)(l.Fragment, {
            children: [
              (0, l.jsx)(f, { href: "/cursor/terminal.svg" }),
              (0, l.jsx)(f, { href: "/cursor/paint.svg" }),
            ],
          });
        },
        y = function (e) {
          var t = e.cursor,
            n = "terminal" !== t && "paint" !== t && "none" !== t;
          return (0, l.jsxs)("div", {
            style: {
              filter: n
                ? "drop-shadow(0 0 0.2rem black) drop-shadow(0 0 0.2rem black)"
            ...
            children: [
              ...
              (0, l.jsxs)("div", {
                ...
                children: [
                  "computer-on" === t &&
                    (0, l.jsx)(l.Fragment, { children: "boot up" }),
                  "contact" === t &&
                    (0, l.jsx)(l.Fragment, { children: "say hi!" }),
                  "spill" === t &&
                    (0, l.jsxs)(l.Fragment, {
                      children: ["spill", (0, l.jsx)("br", {}), "coffee"],
                    }),
                  "unspill" === t &&
                    (0, l.jsx)(l.Fragment, { children: "unspill" }),
                  "open-project" === t &&
                    (0, l.jsx)(l.Fragment, { children: "explore" }),
                  "close-project" === t &&
                    (0, l.jsx)(l.Fragment, { children: "go back" }),
                  "external" === t &&
                    (0, l.jsx)(l.Fragment, { children: "visit" }),
                  "telegram" === t &&
                    (0, l.jsx)(l.Fragment, { children: "Telegram" }),
                  "twitter" === t &&
                    (0, l.jsx)(l.Fragment, { children: "Twitter" }),
                  "dexscreener" === t &&
                    (0, l.jsx)(l.Fragment, { children: "Dexscreener" }),
                  "dextools" === t &&
                    (0, l.jsx)(l.Fragment, { children: "Dextools" }),
                ],
              }),
            ],
          });
        ...
        v = (0, s.Z)(function (e) {
          return {
            ...
            removeHoverById: function (t) {
              return e(function (e) {
                var n = new Map(e.currentlyHovering);
                return n.delete(t), { currentlyHovering: n };
              });
            },
            startHover: function (t, n) {
              return e(function (e) {
                var r = new Map(e.currentlyHovering);
                return r.delete(n), r.set(n, t), { currentlyHovering: r };
              });
            },
            stopHover: function (t) {
              return e(function (e) {
                var n = new Map(e.currentlyHovering);
                return n.delete(t), { currentlyHovering: n };
              });
            ...
            clearAllHovers: function () {
              e(function () {
                return { currentlyHovering: new Map() };
              });
            },
          };
        }),
        ...
        g = function () {
          var e = (0, o.useMemo)(function () {
            return Symbol("hoverable-thing");
          }, []);
          return m(function (t) {
            return {
              startHover: function (n) {
                return t.startHover(n, e);
              },
              stopHover: function () {
                return t.stopHover(e);
              },
            };
          });
        },
      ...
      function w() {
        var e = (0, o.useState)(!1),
            ...
            return (
              (0, o.useEffect)(function () {
                var e = function () {
                  ...
                  r = function (e) {
                    b(e.relatedTarget) && n(!1), b(e.target) && n(!0);
                  };
                return (
          ...
          c = "false" === (0, d.J)("cursor", "true"),
          u = m(function (e) {
            var t = (0, r.Z)(e.currentlyHovering.values()).pop();
            return null !== t && void 0 !== t ? t : "default";
          }),
          f = a && t && !c && u && s,
          v = (0, o.useRef)(null);
        return (
          (0, i.OR)("mousemove", function (e) {
            t || n(!0),
              v.current &&
                (v.current.style.transform = "translate("
                  .concat(e.clientX, "px, ")
                  .concat(e.clientY, "px)"));
          }),
          (0, l.jsxs)(l.Fragment, {
            children: [
              ...
              (0, l.jsx)("div", {
                className:
                  "pointer-events-none fixed top-0 left-0 z-[99999999]",
                ref: v,
                children: f ? (0, l.jsx)(y, { cursor: u }) : null,
              }),
            ],
          })
        );
    ...
    9152: function (e, t, n) {
      ...
      var r = n(7294),
        ...
        f = (e, t) => {
          ...
          if (s) for (var n of s(t)) u.call(t, n) && l(e, n, t[n]);
          return e;
        };
      ...
      const g = ["strong", "em", "code", "underline", "strike-through"];

      function b(e, t, n) {
        if (!p(e) || !e.marks) return [];
      ...
      function x(e, t) {
        ...
        if (y(e) && (e.level || 1) === n && o && (e.listItem || "normal") === r)
          return e;
        if (!("children" in e)) return;
        const i = e.children[e.children.length - 1];
        return i && !p(i) ? x(i, t) : void 0;
      }
      ...
      var E = Object.defineProperty,
        ...
        C = (e, t, n) =>
          t in e
            ...
            : (e[t] = n),
        T = (e, t) => {
          for (var n in t || (t = {})) P.call(t, n) && C(e, n, t[n]);
      ...
      function D(e, t) {
        const n = t,
          { block: r, list: o, listItem: i, marks: a, types: s } = n,
          c = M(n, ["block", "list", "listItem", "marks", "types"]);
        return T(
          I(T({}, e), {
            block: R(e, t, "block"),
            list: R(e, t, "list"),
            listItem: R(e, t, "listItem"),
            marks: R(e, t, "marks"),
            types: R(e, t, "types"),
          }),
          c
      ...
      const H = { display: "none" },
        U = {
          types: {},
          block: {
            normal: ({ children: e }) => r.createElement("p", null, e),
            blockquote: ({ children: e }) =>
              r.createElement("blockquote", null, e),
            h1: ({ children: e }) => r.createElement("h1", null, e),
            h2: ({ children: e }) => r.createElement("h2", null, e),
            h3: ({ children: e }) => r.createElement("h3", null, e),
            h4: ({ children: e }) => r.createElement("h4", null, e),
            h5: ({ children: e }) => r.createElement("h5", null, e),
            h6: ({ children: e }) => r.createElement("h6", null, e),
          },
          marks: {
            em: ({ children: e }) => r.createElement("em", null, e),
            strong: ({ children: e }) => r.createElement("strong", null, e),
            code: ({ children: e }) => r.createElement("code", null, e),
            underline: ({ children: e }) =>
              r.createElement("span", { style: N }, e),
            "strike-through": ({ children: e }) =>
              r.createElement("del", null, e),
            link: ({ children: e, value: t }) =>
              r.createElement("a", { href: null == t ? void 0 : t.href }, e),
          },
          list: {
            number: ({ children: e }) => r.createElement("ol", null, e),
            bullet: ({ children: e }) => r.createElement("ul", null, e),
          },
          listItem: ({ children: e }) => r.createElement("li", null, e),
          hardBreak: () => r.createElement("br", null),
          unknownType: ({ value: e, isInline: t }) => {
            const n = G(e._type);
            return t
              ? r.createElement("span", { style: H }, n)
              : r.createElement("div", { style: H }, n);
          },
          ...
          unknownList: ({ children: e }) => r.createElement("ul", null, e),
          unknownListItem: ({ children: e }) => r.createElement("li", null, e),
          unknownBlockStyle: ({ children: e }) => r.createElement("p", null, e),
        },
        V = (0, r.createContext)(U);

      function z({
        value: e,
        components: t,
        listNestingMode: n,
        onMissingComponent: o = L,
      }) {
        const s = o || W,
          c = (function (e, t) {
            const n = [];
            ...
            for (let c = 0; c < e.length; c++) {
              ...
              if (u)
                if (h(u))
                  if (r)
                    if (w(u, r)) r.children.push(u);
                    else if ((u.level || 1) > r.level) {
                      const e = O(u, c, t);
                      if ("html" === t) {
                        const t = r.children[r.children.length - 1],
                          n =
                            ((o = f({}, t)),
                            (s = { children: [...t.children, e] }),
                            i(o, a(s)));
                      ...
                      const e = n[n.length - 1],
                        o = e && x(e, u);
                      if (o) {
                        (r = o), r.children.push(u);
                        continue;
                      }
                      (r = O(u, c, t)), n.push(r);
                    } else if (u.listItem === r.listItem)
                      console.warn("Unknown state encountered for block", u),
                        n.push(u);
                    else {
                      const e = n[n.length - 1],
                        o = e && x(e, { level: u.level || 1 });
                  ...
                  else (r = O(u, c, t)), n.push(r);
                else n.push(u), (r = void 0);
            }
            var o, s;
            return n;
          })(Array.isArray(e) ? e : [e], n || "html"),
          u = (0, r.useContext)(V),
          l = (0, r.useMemo)(() => (t ? D(u, t) : u), [u, t]),
          p = (0, r.useMemo)(() => F(l, s), [l, s]),
          d = c.map((e, t) =>
            p({ node: e, index: t, isInline: !1, renderNode: p })
          );
        return t
          ? r.createElement(V.Provider, { value: l }, d)
          : r.createElement(r.Fragment, null, d);
      }

      const F = (e, t) => {
        function n(o) {
          const { node: i, index: a, isInline: s } = o,
            c = i._key || `node-${a}`;
          return y(i)
            ? (function (o, i, a) {
                const s = o.children.map((e, t) =>
                    n({
                      node: e._key ? e : I(T({}, e), { _key: `li-${i}-${t}` }),
                      index: i,
                      isInline: !1,
                      renderNode: n,
                    })
                  ...
                  c = e.list,
                  u =
                    ("function" === typeof c ? c : c[o.listItem]) ||
                    e.unknownList;
                if (u === e.unknownList) {
                  const e = o.listItem || "bullet";
                  t(q(`list style "${e}"`, "list"), {
                    nodeType: "listStyle",
                    type: e,
                  });
                }
                return r.createElement(
                  u,
                  { key: a, value: o, index: i, isInline: !1, renderNode: n },
                  s
                );
              })(i, a, c)
            : h(i)
            ? (function (o, i, a) {
                const s = B({ node: o, index: i, isInline: !1, renderNode: n }),
                  c = e.listItem,
                  u =
                    ("function" === typeof c ? c : c[o.listItem]) ||
                    e.unknownListItem;
                if (u === e.unknownListItem) {
                  const e = o.listItem || "bullet";
                  t(q(`list item style "${e}"`, "listItem"), {
                    type: e,
            ...
            : v(i)
            ? (function (o, i, a) {
                const { markDef: s, markType: c, markKey: u } = o,
                  l = e.marks[c] || e.unknownMark,
                  f = o.children.map((e, t) =>
                    n({ node: e, index: t, isInline: !0, renderNode: n })
                  );
                l === e.unknownMark &&
                  t(((e) => q(`mark type "${e}"`, "marks"))(c), {
                    nodeType: "mark",
                    type: c,
                  });
                return r.createElement(
            ...
            : d(i)
            ? (function (o, i, a, s) {
                const c = B({ node: o, index: i, isInline: s, renderNode: n }),
                  { _key: u } = c,
                  l = M(c, ["_key"]),
                  f = l.node.style || "normal",
                  p =
                    ("function" === typeof e.block ? e.block : e.block[f]) ||
                    e.unknownBlockStyle;
                p === e.unknownBlockStyle &&
                  t(q(`block style "${f}"`, "block"), {
                    nodeType: "blockStyle",
                    type: f,
                  });
                return r.createElement(
                  p,
                  I(T({ key: a }, l), { value: l.node, renderNode: n })
                );
              })(i, a, c, s)
            : m(i)
            ? (function (t, n) {
                if ("\n" === t.text) {
                  const t = e.hardBreak;
                  return t ? r.createElement(t, { key: n }) : "\n";
                }
                return t.text;
              })(i, c)
            : (function (o, i, a, s) {
                const c = e.types[o._type],
                  u = { value: o, isInline: s, index: i, renderNode: n };
                if (c) return r.createElement(c, T({ key: a }, u));
                t(G(o._type), { nodeType: "block", type: o._type });
                const l = e.unknownType;
                return r.createElement(l, T({ key: a }, u));
              })(i, a, c, s);
        }
        ...
        const { node: t, index: n, isInline: r, renderNode: o } = e,
          i = (function (e) {
            ...
            for (let s = 0; s < n.length; s++) {
              ...
              if (a.length > 1)
                for (; c < a.length; c++) {
                  const e = (null == (t = a[c]) ? void 0 : t.markKey) || "",
                    n = i.indexOf(e);
                  if (-1 === n) break;
                  i.splice(n, 1);
                }
              ...
              if (u) {
                for (const t of i) {
                  ...
                  u.children.push(i), a.push(i), (u = i);
                }
                if (p(e)) {
                ...
                } else u.children = u.children.concat(e);
              }
            }
            return i.children;
          })(t),
      ...
      var J =
        "undefined" !== typeof n.g &&
        "[object global]" === {}.toString.call(n.g);
      ...
      function te() {
        ...
        if (X(r)) return "https://vimeo.com/".concat(r);
        if (K(r)) return r.replace("http:", "https:");
        if (t)
          throw new TypeError(
            "\u201c".concat(t, "\u201d is not a valid video id.")
          );
        throw new TypeError(
          "\u201c".concat(r, "\u201d is not a vimeo.com url.")
        );
      }

      var ne = "undefined" !== typeof Array.prototype.indexOf,
        re =
          "undefined" !== typeof window &&
        ...
        if (!e.WeakMap) {
          ...
          e.WeakMap = (function () {
            function e() {
              ...
              if ((r(this, "_id", i("_WeakMap")), arguments.length > 0))
        ...
        se =
          ((ie = function (e) {
            ...
            (r = function () {
              ...
              ((n = oe)[(t = "Promise")] = n[t] || r()),
              e.exports && (e.exports = n[t]);
          }),
          ie((ae = { exports: {} }), ae.exports),
          ae.exports),
        ce = new WeakMap();

      function ue(e, t, n) {
        var r = ce.get(e.element) || {};
        t in r || (r[t] = []), r[t].push(n), ce.set(e.element, r);
      }

      function le(e, t) {
        return (ce.get(e.element) || {})[t] || [];
      }

      function fe(e, t, n) {
        var r = ce.get(e.element) || {};
        if (!r[t]) return !0;
        if (!n) return (r[t] = []), ce.set(e.element, r), !0;
        var o = r[t].indexOf(n);
        return (
          -1 !== o && r[t].splice(o, 1),
          ce.set(e.element, r),
      ...
      function ye(e, t) {
        ...
        if ((t = de(t)).event) {
          if ("error" === t.event)
            le(e, t.data.method).forEach(function (n) {
              var r = new Error(t.data.message);
              (r.name = t.data.name), n.reject(r), fe(e, t.data.method, n);
            });
          (r = le(e, "event:".concat(t.event))), (n = t.data);
        } else if (t.method) {
          var o = (function (e, t) {
            var n = le(e, t);
      ...
      function be(e) {
        ...
        return new Promise(function (r, o) {
          if (!K(e))
            throw new TypeError(
              "\u201c".concat(e, "\u201d is not a vimeo.com url.")
            );
            ...
            (s.onload = function () {
              if (404 !== s.status)
                if (403 !== s.status)
                  ...
                  o(new Error("\u201c".concat(e, "\u201d is not embeddable.")));
      ...
      var we = new WeakMap(),
        ...
        je = (function () {
          function e(t) {
            ...
            if ("IFRAME" === t.nodeName && !K(t.getAttribute("src") || ""))
              throw new Error(
            ...
            (this._window = t.ownerDocument.defaultView),
              (this.element = t),
              (this.origin = "*");
            var i = new se(function (e, o) {
              if (
                ((n._onMessage = function (t) {
                  if (K(t.origin) && n.element.contentWindow === t.source) {
            ...
            if (
              (Oe.set(this, i),
              we.set(this.element, this),
              "IFRAME" === this.element.nodeName && he(this, "ping"),
              xe.isEnabled)
            ) {
              var a = function () {
                return xe.exit();
              ...
              (this.fullscreenchangeHandler = function () {
                xe.isFullscreen
                  ? ue(n, "event:exitFullscreen", a)
                  : fe(n, "event:exitFullscreen", a),
                  n.ready().then(function () {
                    he(n, "fullscreenchange", xe.isFullscreen);
                  });
              }),
                xe.on("fullscreenchange", this.fullscreenchangeHandler);
            }
            return this;
          }
            ...
            (n = [
                ...
                value: function (e) {
                  ...
                  return new se(function (r, o) {
                    return t
                      .ready()
                      .then(function () {
                        ue(t, e, { resolve: r, reject: o }), he(t, e, n);
                      })
                      .catch(o);
                  });
                },
                  ...
                  return new se(function (n, r) {
                    return (
                      ...
                      t
                        .ready()
                        .then(function () {
                          ue(t, e, { resolve: n, reject: r }), he(t, e);
                        })
                        .catch(r)
                    );
                  });
              ...
              },
              {
                ...
                value: function (e, t) {
                  var n = this;
                  return new se(function (r, o) {
                    if (((e = Q(e, "set")), void 0 === t || null === t))
                      throw new TypeError("There must be a value to set.");
                    return n
                      .ready()
                      .then(function () {
                        ue(n, e, { resolve: r, reject: o }), he(n, e, t);
                      })
                      .catch(o);
                  });
                },
              },
              {
                ...
                value: function (e, t) {
                  ...
                  0 === le(this, "event:".concat(e)).length &&
                    this.callMethod("addEventListener", e).catch(
                      function () {}
                    ),
                    ue(this, "event:".concat(e), t);
                },
              },
              {
                key: "off",
                ...
                value: function () {
                  ...
                  return new se(function (t) {
                    ...
                    e._window.removeEventListener("message", e._onMessage),
                      xe.isEnabled &&
                        xe.off("fullscreenchange", e.fullscreenchangeHandler),
                      t();
                  });
                },
              },
      ...
      J ||
        ...
        (function () {
          ...
          if (!window.VimeoPlayerResizeEmbeds_) {
            ...
            var t = function (t) {
              if (K(t.origin) && t.data && "spacechange" === t.data.event)
                for (
      ...
      var ke = {
        ...
        Ae = (function (e) {
          ...
          function o(t) {
            var n;
            return (
              ((n = e.call(this, t) || this).refContainer = n.refContainer.bind(
                (function (e) {
                  if (void 0 === e)
          ...
          return (
            ...
            (i.componentDidUpdate = function (e) {
              var t = this,
                n = Object.keys(this.props).filter(function (n) {
                ...
                switch (e) {
                  ...
                  case "paused":
                    n.getPaused().then(function (e) {
                      return r && !e ? n.pause() : !r && e ? n.play() : null;
                    });
                    break;
                  case "width":
                  case "height":
            ...
            (i.createPlayer = function () {
              var e = this,
                t = this.props,
                n = t.start,
                r = t.volume;
              (this.player = new Ee(this.container, this.getInitialOptions())),
                Object.keys(ke).forEach(function (t) {
                  var n = ke[t];
                  e.player.on(t, function (t) {
                    var r = e.props[n];
                    r && r(t);
                  });
                });
              ...
              this.player.ready().then(
                ...
                "number" === typeof n && this.player.setCurrentTime(n),
                "number" === typeof r && this.updateProps(["volume"]);
            }),
            (i.refContainer = function (e) {
              this.container = e;
            }),
            (i.render = function () {
              var e = this.props,
      ...
      var He = {
          projectId: null !== (Ie = "0ttnaq4a") ? Ie : "",
          dataset: null !== (Me = "production") ? Me : "",
          previewMode: !1,
          useCdn: !1,
        ...
        Ue = Le(
          ...
          {
            token:
              null !== (De = qe.env.SANITY_TOKEN) && void 0 !== De ? De : "",
          }
        ),
        Ve = (Ne()(Ue), Ne()(He)),
        ze =
          ((function ({
            ...
            const s = (function (e) {
                const [t] = e;
                if ("v" === t) return e.slice(1);
                return e;
              })(o),
              c = { current: r };

            async function u(e, t) {
              const r = c.current && !!n ? `|| _id=="drafts.${t}"` : "",
                [o] = await l(`* [_id == "${t}" ${r}]`);
              return o;
            }
            ...
            async function l(r) {
              ...
              const l = await (async function (e, t) {
                  ...
                  `https://${t}.${
                    a ? "apicdn" : "api"
                  }.sanity.io/v${s}/data/query/${e}?${o.toString()}`,
                  Object.assign(
                    {},
                ...
                f = "drafts.";
              if (!u) return l.result.filter((e) => !e._id.startsWith(f));
              const p = (e) => (e.startsWith(f) ? e.substring(f.length) : e),
                d = l.result
                  .filter((e) => e._id.startsWith("drafts."))
                  .reduce((e, t) => ((e[p(t._id)] = t), e), {}),
                h = l.result.reduce((e, t) => {
                  const n = p(t._id);
                  return (e[n] = d[n] || t), e;
                }, {});
              return Object.values(h);
            }
          })(Le(Le({}, Ue), {}, { fetch: fetch })),
          Ce()(Ve));
      ...
      var Qe = r.memo(Je),
        ...
        Xe = function (e) {
          var t = e.href,
            n = e.cursor,
            r = void 0 === n ? "external" : n,
            o = e.children,
            i = e.onClick,
            a = void 0 === i ? function () {} : i;
          return (0, We.jsx)(Be.TW, {
            cursor: r,
            children: (0, We.jsxs)("a", {
              ...
              rel: "noreferrer",
              className:
                " relative block p-2 pr-8 font-mono text-center border-[1px] border-[currentColor] hover:text-projectColor hover:border-projectColor hover:fill-projectColor ",
              onClick: a,
              children: [
                o,
                (0, We.jsx)("span", {
                  className:
                    "absolute top-0 grid w-6 h-full right-2 place-items-center fill-[currentColor]",
        ...
        tt = function (e) {
          ...
          return (0, We.jsx)("a", {
            ...
            className:
              "underline decoration-1 underline-offset-4 hover:text-projectColor",
            target: r,
            rel: "_blank" === r ? "noindex nofollow" : "",
            children: n,
          });
        },
        nt = function (e) {
          var t,
            n = e.value;
          return (0, We.jsx)("figure", {
            className: "border-[1px] border-[currentColor]",
        ...
        ot = function (e) {
          var t = e.children;
          return (0, We.jsx)(Ke, { children: t });
        },
        it = function (e) {
          var t = e.children;
          return (0, We.jsx)(et, { children: t });
        },
        at = function (e) {
          var t = e.children;
          return (0, We.jsx)("h3", {
        ...
        ct = function (e) {
          var t = e.value;
          return (0, We.jsxs)("figure", {
            children: [
              (0, We.jsx)("blockquote", { children: t.quote }),
              (0, We.jsxs)("figcaption", {
                children: [
                  (0, We.jsxs)("div", { children: [t.author, ",", t.title] }),
                  (0, We.jsx)("img", {
                    src: Fe(t.headshot).width(800).url(),
                    alt: "hi",
                  }),
                ],
              }),
        ...
        ut = function (e) {
          ...
          return (0, We.jsxs)(We.Fragment, {
            children: [
              ...
              (null !== (r = a.designers) && void 0 !== r && r.length) ||
              a.client
                ? (0, We.jsxs)("div", {
                      ...
                      a.client &&
                        (0, We.jsxs)("dl", {
                          ...
                          children: [
                            ...
                            (0, We.jsx)("dd", { children: a.client }),
                          ],
                        }),
                      (null === (o = a.designers) || void 0 === o
                        ? void 0
                        : o.length) &&
                        (0, We.jsxs)("dl", {
                          className: "mt-8 font-mono",
                          children: [
                            ...
                            (0, We.jsx)("dd", {
                              children: (0, We.jsx)("ul", {
                                children: a.designers.map(function (e) {
                                  return (0, We.jsx)(
                                    "li",
                                    {
                                      children: e.url
                                        ? (0, We.jsx)(Be.TW, {
                                            ...
                                            children: (0, We.jsx)("a", {
                                              ...
                                              rel: "noreferrer",
                                              className:
                                                "inline-block p-0 underline decoration-1 underline-offset-4 hover:text-projectColor hover:border-b-projectColor",
                                              children: e.name,
                                            }),
                                          })
                                        : e.name,
                ...
                : null,
              (null === (i = a.links) || void 0 === i ? void 0 : i.length) &&
                (0, We.jsx)("ul", {
                  className: "col-span-2 mt-8",
                  children: a.links.map(function (e) {
                    var t;
                    return (0, We.jsx)(
                      "li",
                      {
        ...
        lt = function (e) {
          ...
          return (0, r.useMemo)(
            function () {
              var e;
              return (0, We.jsx)("div", {
                className: "my-8 tracking-wide",
                children: (0, We.jsx)(z, {
                  value:
                    null !==
                      (e = null === t || void 0 === t ? void 0 : t.body) &&
                    void 0 !== e
                      ? e
                      : {},
                  components: {
                    marks: { link: tt },
                    types: { quote: ct, link: st, vimeo: rt, imageFigure: nt },
                    block: { h2: it, h3: at, normal: ot },
                  },
                }),
              });
            },
            ...
            children: [
              ...
              (0, We.jsx)(Xe, {
                ...
                onClick: function () {
                  (0, Pe.B)("cta", {
                    type: "email",
                    location: "project-".concat(t),
                  });
                },
                children: "BUY $VOJAK $VOJAK $VOJAK",
              }),
            ],
          });
        };
    ...
    1158: function (e, t, n) {
      ...
      var r = {
        ...
        testimonials: [
          {
            quote:
              "Embrace the soft side of memes with the gentle hue of Pink Vojak.",
            shortName: "Pink",
            name: "Pink Vojak",
            headshot: "/_next/static/media/1.png",
          },
          {
            quote:
              "Feel the fiery passion and intensity of memes with Red Vojak.",
            name: "Red Vojak",
            shortName: "Red",
            headshot: "/_next/static/media/2.png",
          },
          {
            quote:
              "Grounded in humor and rich in expression, meet the earthy Brown Vojak.",
            name: "Brown Vojak",
            shortName: "Brown",
            headshot: "/_next/static/media/3.png",
          },
        ],
        skills: [
          "\n      Ever thought memes were just for laughs? Dive into the memeconomy with $VOJAK token! In today's fast-paced crypto world, even memes have a tangible value. Where internet humor meets blockchain, $VOJAK stands tall.\n    ",
          "\n      $VOJAK isn't just another token; it's a symbol of the online culture revolution. With renounced ownership and guaranteed safety protocols, our token's integrity is paramount. We believe in transparency and security, ensuring your investment remains protected.\n    ",
          "\n      Our mission with $VOJAK is to create a robust and engaged community. To all the meme enthusiasts and crypto aficionados: this is your playground. Together, we can build a space fueled by creativity, trust, and, of course, a good laugh.\n    ",
          "\n      It's not always easy sailing in the crypto world. But with $VOJAK, we're turning dreams into realities. Hold tight, support the vision, and let's shape the future of meme-based tokens. Our dedicated team is here every step of the way, ensuring that $VOJAK is not just a token, but a movement.\n    ",
          "\n      Constructive conversations propel us forward. To our vibrant $VOJAK community: let's continue uplifting and supporting each other. Negative chatter or baseless FUD has no place here. We're on a journey, and every member is essential. Let's make meme history together!\n    ",
          "\n      In conclusion, enjoy the ride with $VOJAK. Our commitment is unwavering, and with a community like ours, the sky's the limit. Every step, every milestone is a testament to our shared vision. From all of us behind $VOJAK, thank you for believing. To the meme frontier and beyond! ❤️\n    ",
        ],
      };
    },
    4711: function (e, t) {
        ...
        !(function () {
          ...
          function b(e, t, r) {
            ...
            !w.search && ~j[0].indexOf("?") && (w.search = "?"),
              ...
              b &&
                !w.host.endsWith(b) &&
                ((w.host += b), (w.port = b.slice(1))),
              (w.href = x ? "" + w.pathname + w.search + w.hash : a(w));
    ...
    7334: function (e) {
      !(function () {
        ...
        !(function () {
          var e = o;
          (e.decode = e.parse = r(540)), (e.encode = e.stringify = r(128));
        })(),
          (e.exports = o);
      })();
    },
    ...
    1462: function (e, t, n) {
      ...
      t.GoogleAnalytics = function ({
        ...
        var r;
        const s = null !== (r = "G-540J4G292N") ? r : e;
        return (
          (0, a.usePageViews)({
            gaMeasurementId: s,
            ignoreHashChange:
              "object" === typeof n &&
              (null === n || void 0 === n ? void 0 : n.ignoreHashChange),
            disabled: !n,
          }),
          s
    ...
    9412: function (e, t, n) {
      ...
      t.usePageViews = function ({
        ...
        const a = (0, o.useRouter)();
        (0, r.useEffect)(() => {
          if (n) return;
          const r = (t) => {
            var n;
            const r = null !== (n = "G-540J4G292N") ? n : e;
            (0, i.pageView)({ path: t.toString() }, r);
          };
          return (
            a.events.on("routeChangeComplete", r),
            t || a.events.on("hashChangeComplete", r),
            () => {
              a.events.off("routeChangeComplete", r),
                t || a.events.off("hashChangeComplete", r);
            }
          );
        }, [a.events, e, t]);
      };
    ...
    9633: function (e, t, n) {
      ...
      const r = n(655);
      t.event = function (e, t = {}, n) {
        var o,
          { category: i, label: a, value: s, nonInteraction: c, userId: u } = t,
          l = r.__rest(t, [
            "category",
            "label",
            "value",
        ...
        if (!(null !== (o = "G-540J4G292N") ? o : n) || !window.gtag) return;
        const f = Object.assign({}, l);
        void 0 !== i && (f.event_category = i),
          void 0 !== a && (f.event_label = a),
          void 0 !== s && (f.value = s),
          void 0 !== c && (f.non_interaction = c),
          void 0 !== u && (f.user_id = u),
          window.gtag("event", e, f);
      };
    },
    8396: function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.event = t.pageView = void 0);
      var r = n(3371);
    ...
    3371: function (e, t) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.pageView = void 0),
        (t.pageView = function (
          { title: e, location: t, path: n, sendPageView: r, userId: o } = {},
          i
        ) {
          var a;
          const s = null !== (a = "G-540J4G292N") ? a : i;
          if (!s || !window.gtag) return;
          const c = {};
          void 0 !== e && (c.page_title = e),
            void 0 !== t && (c.page_location = t),
            void 0 !== n && (c.page_path = n),
            void 0 !== r && (c.send_page_view = r),
          ...
          return (
            o.isFunction(n)
              ...
              : n &&
                ...
                n !== i.empty &&
                  ((u = Object.create(n)),
                  o.isFunction(u.unsubscribe) && c.add(u.unsubscribe.bind(u)),
              ...
              if (!this.closed) {
                ...
                if (i.isFunction(l)) {
                  ...
                  try {
                    ...
                    t = y instanceof a.UnsubscriptionError ? c(y.errors) : [y];
                  }
                }
                if (r.isArray(f)) {
                  p = -1;
                  for (var d = f.length; ++p < d; ) {
                    ...
                    if (o.isObject(h))
                      try {
                        ...
                        (t = t || []),
                          y instanceof a.UnsubscriptionError
                            ? (t = t.concat(c(y.errors)))
                            : t.push(y);
                      }
                  }
                }
    ...
    4564: function (e, t, n) {
      ...
      function h(e) {
        ...
        else if ("string" === i) for (t in ((o = new m(e, {})), d)) delete o[t];
        else if ("object" === i) {
        ...
        for (
          "object" !== w && "string" !== w && ((n = t), (t = null)),
            ...
            (("file:" === s.protocol && (2 !== s.slashesCount || l.test(e))) ||
              (!s.slashes &&
                (s.protocol || s.slashesCount < 2 || !y(O.protocol)))) &&
              (b[3] = [/(.*)/, "pathname"]);
          x < b.length;
          x++
        )
            ...
            ? ((c = u[0]),
              ...
              c !== c
                ...
                ? ~(d = "@" === c ? e.lastIndexOf(c) : e.indexOf(c)) &&
                  ("number" === typeof u[2]
                    ? ((O[g] = e.slice(0, d)), (e = e.slice(d + u[2])))
                    : ((O[g] = e.slice(d)), (e = e.slice(0, d))))
                : (d = c.exec(e)) && ((O[g] = d[1]), (e = e.slice(0, d.index))),
              (O[g] = O[g] || (i && u[3] && t[g]) || ""),
              u[4] && (O[g] = O[g].toLowerCase()))
            : (e = u(e, O));
        n && (O.query = n(O.query)),
          i &&
            t.slashes &&
      ...
      (m.prototype = {
        set: function (e, t, n) {
          ...
          return (
            ...
            (i.origin =
              "file:" !== i.protocol && y(i.protocol) && i.host
                ? i.protocol + "//" + i.host
                : "null"),
            (i.href = i.toString()),
            i
        ...
        toString: function (e) {
          ...
          var a = i + ((n.protocol && n.slashes) || y(n.protocol) ? "//" : "");
          return (
            n.username
              ? ((a += n.username),
    ...
    1485: function (e, t, n) {
      ...
      var u = function () {
        const [e, t] = (0, r.useState)({ width: 0, height: 0 }),
          n = () => {
    ...
    4671: function (e, t, n) {
      ...
      var r = n(9148),
        o = n(7294),
        i = n(2798);
      const { useSyncExternalStoreWithSelector: a } = i;
      const s = (e) => {
        const t = "function" === typeof e ? (0, r.Z)(e) : e,
          n = (e, n) =>
